...
class ECG_DNN_Thread_TrainData:
    ...
    def __init__(self, raw, sampling):
        ...
        self.dnn_model_path = './ecgrdvq_ai_model_240221_0.8_2.pickle'  # 학습모델 저장경로
    ...
    def run_dnn(self):
        ...
        저장
        '''
        with open(r'C:\Users\jjm\Desktop\ecg_ai\trainingDB\ecgdvq_62.5\inp_outp.pickle', 'wb') as f:  # 입,출력 데이터 stack
            pickle.dump(self.stack_arr, f)

        with open(r'C:\Users\jjm\Desktop\ecg_ai\trainingDB\ecgdvq_62.5\rs_i.pickle', 'wb') as f:  # parameter
        ...
        parameter_return = (
            ...
            list(self.ecg_parameter[1::, 22]), list(self.ecg_parameter[1::, 23]), list(self.ecg_parameter[1::, 24]),
            list(self.ecg_parameter[1::, 25]), list(self.ecg_parameter[1::, 26]), list(self.ecg_parameter[1::, 27])
        )
